...
//    c->transform = Transform(glm::vec3(0, 0, 0), glm::vec3(0,0,0), glm::vec3(1,1,1));
    c->create();
...
//    s->transform = Transform(glm::vec3(0,0,0), glm::vec3(0,0,0), glm::vec3(1,1,1));
    s->create();
...
//    wall->transform = Transform(glm::vec3(0, 0, 0), glm::vec3(0,0,0), glm::vec3(1,1,1));
    wall->create();
    objects.append(wall);
